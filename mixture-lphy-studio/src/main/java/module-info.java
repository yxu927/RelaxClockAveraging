import mixture.lphystudio.viewer.MixtureModelViewer;

module mixture.lphy.studio {
    ...
    provides lphystudio.app.graphicalmodelpanel.viewer.Viewer with MixtureModelViewer;
