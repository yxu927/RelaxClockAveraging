...
public class HierarchicalSVSLogger extends BEASTObject implements Loggable {
    ...
    public final Input<Boolean> printTopInput =
            new Input<>("printTop", "print top-level rStrict/rRelax and top weights/logL", true);

    public final Input<Boolean> printInnerInput =
            new Input<>("printInner", "print inner UC/AC logP and responsibilities", true);
    ...
    public void init(final PrintStream out) {
        ...
        if (printInner) {
            out.print(p + "innerWUC\t");
            out.print(p + "innerWAC\t");
            out.print(p + "logPUC\t");
            out.print(p + "logPAC\t");
            out.print(p + "rUC\t");
            out.print(p + "rAC\t");
            out.print(p + "indicator\t");
            out.print(p + "ucldStdev\t");
            out.print(p + "sigma2\t");
        }
    ...
    public void log(final long sample, final PrintStream out) {
        ...
        if (printInner) {
            out.print(fmt(wu)); out.print('\t');
            out.print(fmt(wa)); out.print('\t');
            out.print(fmt(logPUC)); out.print('\t');
            out.print(fmt(logPAC)); out.print('\t');
            out.print(fmt(rUC)); out.print('\t');
            out.print(fmt(rAC)); out.print('\t');
            out.print(fmt(indicator)); out.print('\t');
            out.print(fmt(ucldStdev)); out.print('\t');
            out.print(fmt(sigma2)); out.print('\t');
        }
